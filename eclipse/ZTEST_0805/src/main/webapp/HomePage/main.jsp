...
<body>
    ...
    <figure>
        ...
        <div class="inner">
            ...
            <p>Stock Wise Sayings Of Those Who Succeed With Stock<br>
                Let's continue to work hard today and tomorrow</p>
        ...
        <div class="inner">
            ...
            <div class="wrap">
                <article>
                    ...
                    <h2><a href="#"> stay in the market, not to get out</a></h2>
                    <p>when the sentiment changes, it happens so quickly by the time you get bak into themarket, you've already missed out</p>
                </article>
                ...
                <article>
                    ...
                    <h2><a href="#">Chales Fulton Oursler</a></h2>
                    <p>Many of us crucify ourselves between two thieves - regret for the past and fear of the future.</p>
                </article>

                <article>
                    <div class="pic">
                        <img src="img/AlbertEinstein.jpg" alt="4ë²ì§¸ ì½íì¸  ì´ë¯¸ì§">
                    </div>
                    <h2><a href="#">Albert Einstein</a></h2>
