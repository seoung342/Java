		...
		<div class="inner">
			<form method="post" action="notice">
				<input type="hidden" name="num" value="${notice.num }"> <input
					type="hidden" name="hits" value="${notice.hits }"> <input
					type="hidden" name="writer" value="${notice.writer }"> <input
					type="hidden" name="action" value="notice_update">
				<table>
					<tr>
						<th>제목</th>
					...
					<tr>
						<th>내용</th>
						<td><textarea name="content" rows="10">${notice.content }</textarea>
						</td>
					</tr>
				</table>
