		...
		<div class="inner">
			...
			<c:if test="${id != null && name eq notice.writer }">
				<form action="notice" method="post">
					<input type="hidden" name="action" value="notice_fix"> <input
						type="hidden" name="num" value="${notice.num}"> <input
						type="submit" value="수정">
				</form>
				<form action="notice" method="post">
					<input type="hidden" name="action" value="notice_delete"> <input
						type="hidden" name="num" value="${notice.num}"> <input
