...
public class Project1 {
	...
	public static void main(String[] args) {
		...
		try (FileInputStream fis = new FileInputStream("c:\\_dev\\eclipse\\JAVA0715\\src\\project1_2\\members.dat");
			...
			list = new ArrayList<>(Arrays.asList(list2));	// 배열을 ArrayList로 바꾼다.
			...
			case 3:
				...
				while (run2) {
					...
					case 1:
						...
						member.AddBalance(Integer.parseInt(scanner.nextLine()));
						break;
					case 2:
						System.out.print("출금액> ");
						member.SubBalance(Integer.parseInt(scanner.nextLine()));
						break;
					case 3:
						System.out.print("잔고> ");
