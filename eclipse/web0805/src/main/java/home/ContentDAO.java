...
public class ContentDAO {
	...
	private String CONTENT_LIST = "select * from test_content";
	private String CONTENT_ONE = "select * from test_content where num = ?";
	private String CONTENT_INSERT = "insert into test_content (writer, title, content, regtime, hits) values (?, ?, ?, now(), 0)";
	private String CONTENT_UPDATE = "update test_content set writer = ?, title = ?, content = ?, regtime = now() where num = ?";
