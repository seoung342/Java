...
public class NoticeDAO {
	...
	private String NOTICE_LIST = "select * from test_notice";
	private String NOTICE_ONE = "select * from test_notice where num = ?";
	private String NOTICE_INSERT = "insert into test_notice (writer, title, content, regtime, hits) values (?, ?, ?, now(), 0)";
	private String NOTICE_UPDATE = "update test_notice set writer = ?, title = ?, content = ?, regtime = now() where num = ?";
